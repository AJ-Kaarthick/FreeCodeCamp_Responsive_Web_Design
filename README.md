...
| 17 | [📚 Book Catalog Table](./17-Book-Catalog-Table) | Viewport configuration, 4-column row spans, meta alignment | ✅ Completed |
| 18 | [📝 Tennis Survey Form](./18-Survey-Form) | FCC Certification Lab, advanced multi-type form inputs, structured field validation | ✅ Completed |
...
2. Navigate into any project folder (e.g., `01-CatPhotoApp/`).
